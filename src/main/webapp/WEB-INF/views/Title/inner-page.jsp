...
<body>
  ...
  <header id="header" class="d-flex align-items-center">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href='<c:url value ="resources/WEB-INF/views/index.jsp"/>'>BizLand<span>.</span></a></h1>
    ...
    <section class="breadcrumbs">
      <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center">
          <h2>Inner Page</h2>
          <ol>
            <li><a href='<c:url value ="resources/WEB-INF/views/index.jsp"/>'>Home</a></li>
            <li>Inner Page</li>
          </ol>
        </div>
