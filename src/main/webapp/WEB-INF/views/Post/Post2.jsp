        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <!-- Title -->
                    <h1 class="logo"><a href='<c:url value ="resources/WEB-INF/views/index.jsp"/>'>Niezbędnik młodej matki po narodzinach dziecka<span></span></a></h1>
                    ...
                    <!-- Preview Image -->
                    <img class="img-fluid rounded" src="assets/img/Mother-and-baby.jpg" alt="">
                    <hr>
