        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    <!-- Title -->
                    <h1 class="logo"><a href='<c:url value ="index"/>'>Artykuły potrzebne do opieki nad dzieckiem<span></span></a></h1>
                    ...
                    <!-- Preview Image -->
                    <img class="img-fluid rounded" src="resources/img/watercolor-baby.png" alt="">
                    <hr>
